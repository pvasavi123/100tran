  ...
  return (
    <section className="w-full bg-gradient-to-b from-white to-slate-100 py-14">
      <div className="mx-auto max-w-7xl px-6 md:px-12">
        ...
        >
          <h4 className="text-[#3b82f6] font-black uppercase tracking-[0.2em] text-xs mb-4">Who We Are</h4>
          <h2 className="text-3xl md:text-5xl font-black text-[#2f4a6d] leading-tight tracking-tighter">
            We are your <span className="text-[#3b82f6]">Global Partners</span> in education.
          </h2>

          <p className="mx-auto mt-3 max-w-2xl text-sm md:text-base text-[#2f4a6d] opacity-70">
        ...
        <div className="grid items-center gap-8 md:grid-cols-2">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <p className="text-base leading-7 text-[#2f4a6d] opacity-80">
            ...
            <p className="mt-4 text-base leading-7 text-[#2f4a6d] opacity-80">
